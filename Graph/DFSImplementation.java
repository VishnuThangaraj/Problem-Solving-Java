...
/*
Given a connected undirected graph consisting of n vertices and e edges. 
All the edges are given in form of a 2-D matrix edges of size e * 2, 
where there is an undirected edge between edges[i][0] and edges[i][1] for all i ∈ {0, e-1}.
